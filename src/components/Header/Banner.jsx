...
const Banner = () => {
    return (
        <div style={{
            borderRadius: '24px', objectFit: 'cover', backgroundSize:'fit', backgroundRepeat:'no-repeat', 
            background: `linear-gradient(0deg, rgba(21, 11, 43, 0.90) 0%, rgba(21, 11, 43, 0.00) 100%), url(${BG}) lightgray 0px -18.896px / 100% 123.31%`}}>
            <div className="w-full lg:w-[60%] mx-auto py-14 lg:pt-[130px] lg:pb-[260px] px-5 text-center text-white">
